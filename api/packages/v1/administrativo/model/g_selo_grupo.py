...
G_SELO_GRUPO_ATTRIBUTES: dict[str, dict[str, Any]] = {
    ...
    "CONTROLE_AUTOMATICO": {"type": DataTypes.STRING(2), "allowNull": True},
    ...
    "AGRUPADOR": {"type": DataTypes.STRING(2), "allowNull": True},
    "UM_POR_PROTOCOLO": {"type": DataTypes.STRING(2), "allowNull": True},
    ...
    "ENVIO_AUTOMATICO": {"type": DataTypes.STRING(2), "allowNull": True},
