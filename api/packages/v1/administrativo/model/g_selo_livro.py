...
G_SELO_LIVRO_ATTRIBUTES: dict[str, dict[str, Any]] = {
    ...
    "INFORMADO": {"type": DataTypes.STRING(2), "allowNull": True},
    "DATA_INFORMACAO": {"type": DataTypes.TIMESTAMP(), "allowNull": True},
    "RESERVADO": {"type": DataTypes.STRING(2), "allowNull": True},
    ...
    "ISS_COBRADO_USUARIO": {"type": DataTypes.STRING(2), "allowNull": True},
    "CONCILIADO": {"type": DataTypes.STRING(2), "allowNull": True},
    ...
    "ENVIO_IMEDIATO": {"type": DataTypes.STRING(2), "allowNull": True},
    ...
    "SITUACAO_DIFERIDO": {"type": DataTypes.STRING(2), "allowNull": True},
    "DATA_INUTILIZACAO": {"type": DataTypes.TIMESTAMP(), "allowNull": True},
    "SELO_PROTOCOLO": {"type": DataTypes.STRING(2), "allowNull": True},
