...
class GEmolumentoItemSaveRepository(BaseRepository):
    ...
    def execute(self, g_emolumento_item_save_schema: GEmolumentoItemSaveSchema):
        ...
        Args:
            g_emolumento_item_save_schema (GEmolumentoItemSchema): O esquema com os dados a serem salvos.
        ...
        try:
            ...
            # ----------------------------------------------------
            params = g_emolumento_item_save_schema.model_dump(exclude_unset=True)
