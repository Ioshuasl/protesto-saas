...
class ShowTextoImportadoRepository(BaseRepository):
    """Leitura de TEXTO_IMPORTADO via SQL para materializar o BLOB completo."""
    ...
    def _execute_sql(self, arquivo_schema: PArquivoTituloIdSchema) -> dict[str, Any]:
        sql = """
        SELECT ARQUIVO_TITULO_ID, TEXTO_IMPORTADO
