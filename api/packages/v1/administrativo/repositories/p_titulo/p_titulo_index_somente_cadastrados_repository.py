...
_SOMENTE_CADASTRADOS_DATE_CONDITIONS: list[dict[Any, Any]] = [
...
class IndexSomenteCadastradosRepository(IndexRepository):
    @staticmethod
    def _build_base_orm_conditions(
        ...
        conditions.extend(_SOMENTE_CADASTRADOS_DATE_CONDITIONS)
        return conditions
