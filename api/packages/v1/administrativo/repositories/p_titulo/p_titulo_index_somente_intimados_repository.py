...
_SOMENTE_INTIMADOS_DATE_CONDITIONS: list[dict[Any, Any]] = [
...
class IndexSomenteIntimadosRepository(IndexRepository):
    @staticmethod
    def _build_base_orm_conditions(
        ...
        conditions.extend(_SOMENTE_INTIMADOS_DATE_CONDITIONS)
        return conditions
