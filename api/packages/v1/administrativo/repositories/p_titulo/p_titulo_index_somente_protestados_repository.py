...
_SOMENTE_PROTESTADOS_DATE_CONDITIONS: list[dict[Any, Any]] = [
...
class IndexSomenteProtestadosRepository(IndexRepository):
    @staticmethod
    def _build_base_orm_conditions(
        ...
        conditions.extend(_SOMENTE_PROTESTADOS_DATE_CONDITIONS)
        return conditions
