...
from packages.v1.administrativo.actions.t_censec_qualidade.t_censec_qualidade_delete_action import DeleteAction
...
class DeleteService:
    ...
    def execute(self, censec_qualidade_schema: TCensecQualidadeIdSchema):
        ...
        data = delete_action.execute(censec_qualidade_schema)
        ...
        if data:
            ...
            sequencia_schema = GSequenciaDeleteSchema(
                sequencia=censec_qualidade_schema.censec_qualidade_id,
                tabela='T_CENSEC_QUALIDADE'
            )
