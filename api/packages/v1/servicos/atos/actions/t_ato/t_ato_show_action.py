...
from packages.v1.servicos.atos.repositories.t_ato.t_ato_show_repository import (
    TAtoShowRepository,
)
from packages.v1.servicos.atos.schemas.t_ato_schema import TAtoIdSchema


class TAtoShowAction(BaseAction):
    """
    ...
    def execute(self, t_ato_id_schema: TAtoIdSchema):
        ...
        # ----------------------------------------------------
        t_ato_show_repository = TAtoShowRepository()

        # ----------------------------------------------------
        # Execução do repositório
        # ----------------------------------------------------
        response = t_ato_show_repository.execute(t_ato_id_schema)
