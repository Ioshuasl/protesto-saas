...
from packages.v1.servicos.atos.repositories.t_ato_andamento.t_ato_andamento_index_repository import (
    TAtoAndamentoIndexRepository,
)
...
class TAtoAndamentoIndexAction(BaseAction):
    """
    ...
    def execute(self, data: TAtoAndamentoIndexSchema):
        ...
        # ----------------------------------------------------
        t_ato_andamento_index_repository = TAtoAndamentoIndexRepository()

        # ----------------------------------------------------
        # Execução do repositório
        # ----------------------------------------------------
        response = t_ato_andamento_index_repository.execute(data)
