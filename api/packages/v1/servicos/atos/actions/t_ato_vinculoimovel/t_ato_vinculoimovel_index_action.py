...
from packages.v1.servicos.atos.repositories.t_ato_vinculoimovel.t_ato_vinculoimovel_index_repository import (
    TAtoVinculoImovelIndexRepository,
)
...
class TAtoVinculoImovelIndexAction(BaseAction):
    """
    ...
    def execute(self, data: TAtoVinculoImovelIndexSchema):
        ...
        # ----------------------------------------------------
        t_ato_vinculoimovel_index_repository = TAtoVinculoImovelIndexRepository()

        # ----------------------------------------------------
        # Execução do repositório
        # ----------------------------------------------------
        response = t_ato_vinculoimovel_index_repository.execute(data)
