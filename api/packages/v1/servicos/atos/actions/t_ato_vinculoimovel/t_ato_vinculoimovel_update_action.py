...
from packages.v1.servicos.atos.repositories.t_ato_vinculoimovel.t_ato_vinculoimovel_update_repository import (
    TAtoVinculoImovelUpdateRepository,
)
...
class TAtoVinculoImovelUpdateAction(BaseAction):
    """
    ...
    def execute(self, t_ato_vinculoimovel_update_schema: TAtoVinculoImovelUpdateSchema):
        ...
        # ----------------------------------------------------
        t_ato_vinculoimovel_update_repository = TAtoVinculoImovelUpdateRepository()

        # ----------------------------------------------------
        # Execução do repositório
        # ----------------------------------------------------
        response = t_ato_vinculoimovel_update_repository.execute(
