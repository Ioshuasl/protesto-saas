...
from packages.v1.servicos.atos.repositories.t_ato_vinculoparte.t_ato_vinculoparte_index_by_tipo_vinculo_repository import TAtoVinculoParteIndexByTipoVinculoRepository
from packages.v1.servicos.atos.schemas.t_ato_vinculoparte_schema import (
    TAtoVinculoParteIndexByTipoVinculoSchema,
)


class TAtoVinculoParteIndexByTipoVinculoAction(BaseAction):
    """
    ...
    def execute(self, data: TAtoVinculoParteIndexByTipoVinculoSchema):
        ...
        # ----------------------------------------------------
        t_ato_vinculoparte_index_repository = TAtoVinculoParteIndexByTipoVinculoRepository()
