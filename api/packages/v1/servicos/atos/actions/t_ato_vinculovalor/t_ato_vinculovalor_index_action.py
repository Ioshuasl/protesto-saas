...
from packages.v1.servicos.atos.repositories.t_ato_vinculovalor.t_ato_vinculovalor_index_repository import (
    TAtoVinculoValorIndexRepository,
)
...
class TAtoVinculoValorIndexAction(BaseAction):
    """
    ...
    def execute(self, data: TAtoVinculoValorIndexSchema):
        ...
        # ----------------------------------------------------
        t_ato_vinculovalor_index_repository = TAtoVinculoValorIndexRepository()

        # ----------------------------------------------------
        # Execução do repositório
        # ----------------------------------------------------
        response = t_ato_vinculovalor_index_repository.execute(data)
