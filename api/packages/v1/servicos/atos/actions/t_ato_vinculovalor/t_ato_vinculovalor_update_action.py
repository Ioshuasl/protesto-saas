...
from packages.v1.servicos.atos.repositories.t_ato_vinculovalor.t_ato_vinculovalor_update_repository import (
    TAtoVinculoValorUpdateRepository,
)
...
class TAtoVinculoValorUpdateAction(BaseAction):
    """
    ...
    def execute(self, t_ato_vinculovalor_update_schema: TAtoVinculoValorUpdateSchema):
        ...
        # ----------------------------------------------------
        t_ato_vinculovalor_update_repository = TAtoVinculoValorUpdateRepository()

        # ----------------------------------------------------
        # Execução do repositório
        # ----------------------------------------------------
        response = t_ato_vinculovalor_update_repository.execute(
