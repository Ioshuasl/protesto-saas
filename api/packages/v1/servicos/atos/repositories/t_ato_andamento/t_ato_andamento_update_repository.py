...
class TAtoAndamentoUpdateRepository(BaseRepository):
    """
    ...
    def execute(self, t_ato_andamento_update_schema: TAtoAndamentoUpdateSchema):
        """
        Atualiza um registro existente na tabela T_ATO_ANDAMENTO.
        ...
        try:
            ...
            params, update_columns = prepare_update_data(
                ...
                exclude_fields=["ato_andamento_id"],
                id_field="ato_andamento_id",
            )
            ...
            # ----------------------------------------------------
            sql = f"""
                UPDATE T_ATO_ANDAMENTO
                SET {update_columns}
                WHERE ATO_ANDAMENTO_ID = :ato_andamento_id
                RETURNING *;
            """
            ...
            raise HTTPException(
                ...
                detail=f"Erro ao atualizar registro em T_ATO_ANDAMENTO: {str(e)}",
            )
