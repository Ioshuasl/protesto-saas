...
class TAtoVinculoImovelSaveRepository(BaseRepository):
    """
    ...
    def execute(self, t_ato_vinculoimovel_save_schema: TAtoVinculoImovelSaveSchema):
        ...
        Args:
            t_ato_vinculoimovel_save_schema (TAtoVinculoImovelSchema): O esquema com os dados a serem salvos.
        ...
        try:
            ...
            # ----------------------------------------------------
            params = t_ato_vinculoimovel_save_schema.model_dump(
                exclude_unset=True,
                exclude={"usuario_id"},
            )
            ...
            # ----------------------------------------------------
            sql = generate_insert_sql("T_ATO_VINCULOIMOVEL", params)
            ...
            raise HTTPException(
                ...
                detail=f"Erro ao salvar registro em T_ATO_VINCULOIMOVEL: {e}",
            )
