...
class TAtoVinculoImovelUpdateRepository(BaseRepository):
    """
    ...
    def execute(self, t_ato_vinculoimovel_update_schema: TAtoVinculoImovelUpdateSchema):
        """
        Atualiza um registro existente na tabela T_ATO_VINCULOIMOVEL.
        ...
        try:
            ...
            params, update_columns = prepare_update_data(
                ...
                exclude_fields=["ato_vinculoimovel_id", "usuario_id"],
                id_field="ato_vinculoimovel_id",
            )
            ...
            # ----------------------------------------------------
            sql = f"""
                UPDATE T_ATO_VINCULOIMOVEL
                SET {update_columns}
                WHERE ATO_VINCULOIMOVEL_ID = :ato_vinculoimovel_id
                RETURNING *;
            """
            ...
            raise HTTPException(
                ...
                detail=f"Erro ao atualizar registro em T_ATO_VINCULOIMOVEL: {str(e)}",
            )
