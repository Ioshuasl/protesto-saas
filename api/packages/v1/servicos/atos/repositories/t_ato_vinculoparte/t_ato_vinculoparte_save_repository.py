...
class TAtoVinculoParteSaveRepository(BaseRepository):
    """
    ...
    def execute(self, t_ato_vinculoparte_save_schema: TAtoVinculoParteSaveSchema):
        ...
        try:
            ...
            # ----------------------------------------------------
            params = t_ato_vinculoparte_save_schema.model_dump(exclude_unset=True)
            params.pop("usuario_id", None)

            # ----------------------------------------------------
            # Montagem do SQL dinâmico
            # ----------------------------------------------------
            sql = generate_insert_sql("T_ATO_VINCULOPARTE", params)
            ...
            raise HTTPException(
                ...
                detail=f"Erro ao salvar registro em T_ATO_VINCULOPARTE: {e}",
            )