...
class TAtoVinculoValorUpdateRepository(BaseRepository):
    """
    ...
    def execute(self, t_ato_vinculovalor_update_schema: TAtoVinculoValorUpdateSchema):
        """
        Atualiza um registro existente na tabela T_ATO_VINCULOVALOR.
        ...
        try:
            ...
            params, update_columns = prepare_update_data(
                ...
                # Não existe coluna SISTEMA_ID em T_ATO_VINCULOVALOR; campo é usado só em regra de negócio
                exclude_fields=["ato_vinculovalor_id", "sistema_id", "usuario_id"],
                id_field="ato_vinculovalor_id",
            )
            ...
            # ----------------------------------------------------
            sql = f"""
                UPDATE T_ATO_VINCULOVALOR
                SET {update_columns}
                WHERE ATO_VINCULOVALOR_ID = :ato_vinculovalor_id
                RETURNING *;
            """
            ...
            raise HTTPException(
                ...
                detail=f"Erro ao atualizar registro em T_ATO_VINCULOVALOR: {str(e)}",
            )
